...
<style type="text/css">
	#header h1 {
		...
		/* background-image:url('<? bloginfo('stylesheet_directory'); ?>/img/header.png'); */
	}
</style>
	...
	<div id="header">
		...
		<h2 id="quote">
			<?php
			  ...
			  $quotes[] = 'No siembre tubos, siembre arboles!';
			  $quotes[] = 'Un trazado lesivo que pone en peligro nuestra sostenibilidad hidrica y ambiental';
