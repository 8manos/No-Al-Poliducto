...
'/*/WP_I18N_DB_CONN_ERROR*/, $dbhost));
	...
	function set_prefix($prefix) {
		...
		if ( preg_match('|[^a-z0-9_]|i', $prefix) )
			return new WP_Error('invalid_db_prefix', /*WP_I18N_DB_BAD_PREFIX*/'El prefijo de la base de datos no es válido.'/*/WP_I18N_DB_BAD_PREFIX*/);
...
<h1>No es posible seleccionar la base de datos</h1>
<p>Se ha establecido conexión con el servidor de la base de datos (lo que implica que tu nombre de usuario y contraseña son los correctos) pero no es posible seleccionar la base de datos <code>%1$s</code>.</p>
<ul>
<li>¿Estás seguro de que existe?</li>
<li>¿Está autorizado el usuario <code>%2$s</code> para usar la base de datos <code>%1$s</code>?</li>
<li>En algunos sistemas, el nombre de la base de datos lleva como prefijo el nombre de usuario, como en <code>usuario_%1$s</code>. ¿Podría ser ese el problema?</li>
</ul>
<p>Si no sabes cómo configurar una base de datos, <strong>ponte en contacto con tu proveedor de alojamiento</strong>.Si sigues sin encontrar la solución, puedes buscar ayuda en los <a href="http://wordpress.org/support/">Foros de ayuda de WordPress</a>.</p>'/*/WP_I18N_DB_SELECT_DB*/, $db, DB_USER));
			return;
		}
	}
	...
	function get_row($query = null, $output = OBJECT, $y = 0) {
		...
		if ( $output == OBJECT ) {
			...
			$this->print_error(/*WP_I18N_DB_GETROW_ERROR*/' $db->get_row(cadena de consulta, tipo de salida, desplazamiento) -- El tipo de salida debe ser uno de estos: OBJECT, ARRAY_A, ARRAY_N'/*/WP_I18N_DB_GETROW_ERROR*/);
		}
	}
